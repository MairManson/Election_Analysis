...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (voters > county_voter_count) and (voter_percentage > county_voter_percentage):
            county_voter_count = voters
            largest_county_turnout = county_name
            county_voter_percentage = voter_percentage

    # 7: Print the county with the largest turnout to the terminal.
    # Print the final vote count (to terminal)
    largest_voter_turnout = (
        f"\n-------------------------\n"
        f"Largest Voter Turnout: {largest_county_turnout}\n"
        f"-------------------------\n\n")
